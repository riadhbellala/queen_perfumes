  ...
  return (
    <div className="bg-background min-h-screen pb-24">
      ...
      <div className="max-w-6xl mx-auto w-full px-6 lg:px-8 py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <section className="lg:col-span-5 lg:sticky lg:top-24 bg-card rounded-3xl border border-border shadow-sm p-6 md:p-8">
          <div className="flex items-baseline gap-3 mb-8">
            <span className="font-sans text-3xl text-border">
              <bdi dir="ltr">01</bdi>
            </span>
        ...
        <section className="lg:col-span-7 bg-secondary rounded-3xl border border-border shadow-sm overflow-hidden">
          <div className="p-6 md:p-8 pb-5 md:pb-6">
            <div className="flex items-baseline gap-3">
              <span className="font-sans text-3xl text-accent">
                <bdi dir="ltr">02</bdi>
              </span>
              <h2 className="text-2xl font-heading font-medium text-zinc-900">
                {t("orderReviewTitle")}
          ...
          <div className="border-t border-dashed border-foreground/15 mx-6 md:mx-8" />
